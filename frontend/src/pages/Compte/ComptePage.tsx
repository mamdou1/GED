...
import ListeCompte from "./Liste/ListeCompte";
import ListeTypeCompte from "./Liste/ListeTypeCompte";
import ClientListe from "./Liste/ClientListe";

type CompteTab = "types" | "clients" | "comptes"; // ✅ Ajouter "clients"
...
export default function ComptePage() {
  ...
  const tabs = [
    ...
    {
      key: "clients" as const, // ✅ Nouvel onglet
      label: "Clients",
      icon: <Users size={18} />,
    },
    {
  ...
  return (
    <Layout>
      ...
      {activeTab === "clients" && <ClientListe />}{" "}
      {activeTab === "comptes" && <ListeCompte />}
