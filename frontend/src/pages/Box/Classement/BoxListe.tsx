...
// import { useBoxes } from "../../../hooks/useArchivageQueries";
// import { useInitialData } from "../../../hooks/useDocuments";
// import { Box, TypeDocument } from "../../../interfaces";
...
//   // =============================================
//   // REGROUPEMENT DES BOX PAR ENTITÉ → TYPE DE DOCUMENT
//   // =============================================
//   const boxesByEntiteeAndType = useMemo(() => {
//     // Filtrer les box selon les droits d'accès
...
//     // Regrouper par entité de niveau 1 puis par type de document
...
//       // Déterminer l'entité de rattachement
...
//                                       <label
//                                         key={box.id}
//                                         className="flex items-center gap-2 p-2 rounded-lg hover:bg-white cursor-pointer transition-colors group"
//                                       >
//                                         <input
//                                           type="checkbox"
...
//                                           }
//                                           disabled={isFull}
//                                           className="w-4 h-4 text-emerald-600 border-slate-300 rounded focus:ring-emerald-500 disabled:opacity-30"
//                                         />
