...
module.exports = async () => {
  const permissions = [
    ...
    // Courrier - Permissions de visualisation par niveau
    { resource: "courrier", action: "read" },
    { resource: "courrier", action: "read" },
    { resource: "courrier", action: "read" },
    
    // Courrier - Permissions d'action spécifiques
    { resource: "courrier", action: "validate" },
    { resource: "courrier", action: "reject" },
    { resource: "courrier", action: "assign" },
    { resource: "courrier", action: "process" },
    { resource: "courrier", action: "transfer" },
    
    // Courrier - Pièces jointes
    { resource: "courrier", action: "upload_files" },
    { resource: "courrier", action: "download_files" },
