// src/pages/destinataires/DestinatairesExternesForm.tsx
...
import {
  useCreateDestinataireExterne,
  useUpdateDestinataireExterne,
} from "../../hooks/destinataireExterne";
import { DestinataireExterne } from "../../interfaces/destinataireExterne";

interface DestinatairesExternesFormProps {
  visible: boolean;
  onHide: () => void;
...
const DestinatairesExternesForm: React.FC<DestinatairesExternesFormProps> = ({
  visible,
  onHide,
  destinataire,
  onSuccess,
    ...
    try {
      ...
      if (destinataire) {
        ...
        toast.current?.show({
          severity: "success",
          summary: "Succès",
          detail: "Destinataire modifié avec succès",
        });
      } else {
        ...
        toast.current?.show({
          severity: "success",
          summary: "Succès",
          detail: "Destinataire créé avec succès",
        });
      }
      onSuccess();
    } catch (error: any) {
...
export default DestinatairesExternesForm;
