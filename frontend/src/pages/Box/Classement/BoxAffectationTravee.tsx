...
//   // =============================================
//   // AFFECTATION DES BOX À LA TRAVÉE
//   // =============================================
...
//       const boxesToAddCount = selectedBoxes.length;
...
//     setIsAffecting(true);
//     try {
//       // Mettre à jour chaque box avec la nouvelle travée
//       const promises = selectedBoxes.map((box) =>
//         api.put(`/box/${box.boxId}`, {
//           trave_id: selectedTraveId,
//         }),
//       );
...
//         severity: "success",
//         summary: "Succès",
//         detail: `${selectedBoxes.length} box affecté(s) à la travée avec succès`,
//       });
...
//           "Erreur lors de l'affectation des box",
//       });
//     } finally {
...
//     : 0;
//   const capaciteApresAffectation = capaciteActuelle + selectedBoxes.length;
//   const isCapaciteOk =
...
//               Travée sélectionnée : {selectedTrave.code}
//             </h4>
...
//                     Capacité insuffisante ! ({capaciteMax - capaciteActuelle}{" "}
//                     place(s) restante(s))
//                   </p>
//                 </div>
//               )}
...
//               <>
//                 <Columns size={18} />
//                 Affecter {selectedBoxes.length} box à cette travée
//               </>
//             )}
//           </button>
//         </div>
  ...
  const handleRetirer = async () => {
    ...
    try {
      ...
      toastRef.current?.show({
        ...
        summary: "Erreur",
        detail:
          error.response?.data?.message || "Erreur lors du retrait des box",
      });
    } finally {
      setIsAffecting(false);
    }
