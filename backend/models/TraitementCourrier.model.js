module.exports = (sequelize, DataTypes) => {
  const TraitementCourrier = sequelize.define(
    ...
    { tableName: "traitement_courrier", underscored: true, timestamps: true }
  );

  TraitementCourrier.associate = (models) => {
    TraitementCourrier.belongsTo(models.Courrier, { foreignKey: "courrier_id", as: "courrier" });
    TraitementCourrier.belongsTo(models.AttributionCourrier, { foreignKey: "attribution_id", as: "attribution" });
    TraitementCourrier.belongsTo(models.Agent, { foreignKey: "agent_id", as: "agent" });
  };
